...
export default function MediaEditorPage() {
  ...
  return <div className="space-y-6">
    ...
    <TrimTimeline duration={duration} start={trimStart} end={trimEnd} disabled={!file} onChange={(start, end) => { setTrimStart(start); setTrimEnd(end); setRenderedBlob(null); }} onPreview={previewTrim} />
